...
The top ten facilities by total population was found and the corresponding graph is provided ([top-10-facilities-by-population-and-state.png](top-10-facilities-by-population-and-state.png)). We can also see a statewise differentiation, showing that Texas and Louisiana both have 2 centers in the top 10. Beyond this, the graph [top-10-facilities-by-population-of-levels.png](top-10-facilities-by-population-of-levels.png) shows the total population with a breakdonw in terms of the gour levels. Further, the top 10 states with highest population was also found with the graph provided in the repository ([top-10-states-by-population.png](top-10-states-by-population.png)). 
