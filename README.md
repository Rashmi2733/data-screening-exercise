...
The top ten facilities by total population was found and the corresponding graph is provided (`top-10-facilities-by-population-and-state.png`). Further, the top 10 states with highest population was also found with the graph provided in the repository (`top-10-states-by-population.png`). 
